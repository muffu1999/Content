...
-->
  ...
  <input type="submit" name='update' class="btn btn-primary" value="Edit profile"> 
...
$query_update="update users set user_firstname='{$firstname}',user_lastname='{$lastname}',username='{$username}',user_email='{$email}' where username='$username'";
$update_user=mysqli_query($con,$query_update);
echo "<script>alert('profile updated');window.location='admin/includes/logout.php';</script>";
