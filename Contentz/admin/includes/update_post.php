...
?>
   ...
   <form action="" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <input type="text" name="post_user" value="<?php echo $user ?>" class="form-control" readonly>
...
if(isset($_POST['update']))
{
    ...
    $query="update posts set post_cat_id='$post_category',post_title='$post_title',post_user='$post_user',post_date=now(),post_image='$post_image',post_content='$post_cooment',post_tags='$post_tags',post_comment_count='$post_comment_count',post_status='$post_status' where post_id=$post_id";
