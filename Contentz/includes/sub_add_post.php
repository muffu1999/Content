<?php 
if($_SESSION['role']&& $_SESSION['role']=='Subscriber')
{
...
if(isset($_POST['submit']))
{
    ...
    if($insert)
    {
        echo "<script>alert('Post submitted.Waiting for admin approval to publish')</script>";
    }
}
  ...
  <form action="" method="post" enctype="multipart/form-data">
   ...
   <div class="form-group">
      ...
      <div class="form-group">
       ...
       <input type="text" name="post_user" class="form-control" value="<?php echo $users; ?>" readonly>
      </div>
